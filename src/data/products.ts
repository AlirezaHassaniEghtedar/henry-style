...
export const products: Product[] = [
  {
    ...
    image: `${B}/photo-1521572163474-6864f9cf17ab?w=600&h=720&fit=crop&auto=format`,
    images: [
      `${B}/photo-1521572163474-6864f9cf17ab?w=600&h=720&fit=crop&auto=format`,
      `${B}/photo-1556821840-3a63f8a79c65?w=600&h=720&fit=crop&auto=format`,
      `${B}/photo-1576566588028-4147f3842f27?w=600&h=720&fit=crop&auto=format`,
    ],
  ...
  },
  {
    ...
    image: `${B}/photo-1529139574466-a303027244db?w=600&h=720&fit=crop&auto=format`,
    images: [
      `${B}/photo-1529139574466-a303027244db?w=600&h=720&fit=crop&auto=format`,
      `${B}/photo-1503341504253-dff4815485f1?w=600&h=720&fit=crop&auto=format`,
    ],
    sizes: ["S", "M", "L", "XL", "2XL", "3XL"],
  ...
  },
  {
    ...
    image: `${B}/photo-1576566588028-4147f3842f27?w=600&h=720&fit=crop&auto=format`,
    images: [
      `${B}/photo-1576566588028-4147f3842f27?w=600&h=720&fit=crop&auto=format`,
      `${B}/photo-1562157873-818bc0726f68?w=600&h=720&fit=crop&auto=format`,
    ],
    sizes: ["S", "M", "L", "XL", "2XL", "3XL"],
  ...
  },
  {
    ...
    image: `${B}/photo-1583743814966-8d4f369d012d?w=600&h=720&fit=crop&auto=format`,
    images: [
      `${B}/photo-1583743814966-8d4f369d012d?w=600&h=720&fit=crop&auto=format`,
      `${B}/photo-1571945153237-4929e783af4a?w=600&h=720&fit=crop&auto=format`,
    ],
    sizes: ["S", "M", "L", "XL", "2XL", "3XL"],
  ...
  },
  {
    ...
    image: `${B}/photo-1618354691373-d851c5c827ad?w=600&h=720&fit=crop&auto=format`,
    images: [
      `${B}/photo-1618354691373-d851c5c827ad?w=600&h=720&fit=crop&auto=format`,
      `${B}/photo-1576566588028-4147f3842f27?w=600&h=720&fit=crop&auto=format`,
    ],
    sizes: ["S", "M", "L", "XL", "2XL", "3XL"],
    colors: ["#1a1a1a", "#f5f5f0"],
  ...
  },
  {
    ...
    image: `${B}/photo-1556821840-3a63f8a79c65?w=600&h=720&fit=crop&auto=format`,
    images: [
      `${B}/photo-1556821840-3a63f8a79c65?w=600&h=720&fit=crop&auto=format`,
      `${B}/photo-1521572163474-6864f9cf17ab?w=600&h=720&fit=crop&auto=format`,
    ],
  ...
  },
  {
    ...
    image: `${B}/photo-1503341504253-dff4815485f1?w=600&h=720&fit=crop&auto=format`,
    images: [
      `${B}/photo-1503341504253-dff4815485f1?w=600&h=720&fit=crop&auto=format`,
      `${B}/photo-1583743814966-8d4f369d012d?w=600&h=720&fit=crop&auto=format`,
    ],
...
export const categories = [
  {
    ...
    emoji: "🎬",
    image: `${B}/photo-1521572163474-6864f9cf17ab?w=600&h=400&fit=crop&auto=format`,
  },
  {
    id: "car",
    label: "رترو خودرو",
    emoji: "🚗",
    image: `${B}/photo-1583743814966-8d4f369d012d?w=600&h=400&fit=crop&auto=format`,
  },
  {
    id: "national",
    label: "فروهر و هویت ملی",
    emoji: "🦅",
    image: `${B}/photo-1576566588028-4147f3842f27?w=600&h=400&fit=crop&auto=format`,
  },
  {
    id: "street",
    label: "استریت و اسپرت",
    emoji: "🔥",
    image: `${B}/photo-1556821840-3a63f8a79c65?w=600&h=400&fit=crop&auto=format`,
  },
];
